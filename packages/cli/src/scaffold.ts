...
function projectFiles(
  ...
  const files: Record<string, string> = {
    ...
    [`src/components/Welcome.${jsxExt}`]: options.tailwind
      ? `export default function Welcome() {\n  return (\n    <div className="min-h-screen bg-[#08090a] text-zinc-100 antialiased selection:bg-white selection:text-black">\n      <div className="mx-auto min-h-screen max-w-7xl border-x border-white/10">\n        <header className="flex h-20 items-center justify-between border-b border-white/10 px-5 sm:px-8 lg:px-10">\n          <img src="/logo.svg" alt="Inst.js" className="h-8 w-auto sm:h-9" />\n          <a className="font-mono text-xs uppercase tracking-[0.18em] text-zinc-500 transition-colors hover:text-white" href="https://github.com/kawinduwijewardhane/inst.js">GitHub</a>\n        </header>\n\n        <main className="grid min-h-[calc(100vh-5rem)] lg:grid-cols-[5rem_1fr]">\n          <aside className="hidden border-r border-white/10 lg:flex lg:flex-col lg:items-center lg:justify-between lg:py-8">\n            <span className="h-2 w-2 bg-white" />\n            <span className="-rotate-90 whitespace-nowrap font-mono text-[10px] uppercase tracking-[0.3em] text-zinc-600">Inst.js</span>\n            <span className="h-px w-5 bg-white/20" />\n          </aside>\n\n          <section className="relative flex items-center overflow-hidden px-5 py-16 sm:px-8 sm:py-20 lg:px-16 xl:px-20">\n            <div className="pointer-events-none absolute inset-0 opacity-30 [background-image:linear-gradient(to_right,rgba(255,255,255,0.045)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.045)_1px,transparent_1px)] [background-size:72px_72px]" />\n            <div className="pointer-events-none absolute right-8 top-8 hidden h-24 w-24 border-r border-t border-white/10 sm:block" />\n\n            <div className="relative z-10 w-full max-w-4xl">\n              <div className="mb-9 flex items-center gap-3 font-mono text-xs uppercase tracking-[0.16em] text-zinc-500">\n                <span className="inline-block h-2 w-2 bg-emerald-400" />\n                <span>Inst.js is running.</span>\n              </div>\n\n              <h1 className="max-w-3xl text-5xl font-medium leading-[0.95] tracking-[-0.055em] text-white sm:text-7xl lg:text-8xl">\n                Your app\n                <span className="block text-zinc-500">is ready.</span>\n              </h1>\n\n              <div className="mt-10 max-w-2xl border-l border-white/20 pl-5 sm:mt-12 sm:pl-6">\n                <p className="text-sm leading-7 text-zinc-400 sm:text-base">\n                  Edit <code className="font-mono text-zinc-100">src/pages/home.${jsxExt}</code> and save to see your changes.\n                </p>\n              </div>\n\n              <div className="mt-10 flex flex-wrap items-center gap-3">\n                <a href="https://github.com/kawinduwijewardhane/inst.js" className="inline-flex h-11 items-center border border-white bg-white px-5 text-sm font-medium text-black transition-colors hover:bg-zinc-200">Documentation</a>\n                <a href="https://github.com/kawinduwijewardhane/inst.js" className="inline-flex h-11 items-center border border-white/15 px-5 text-sm font-medium text-zinc-300 transition-colors hover:border-white/40 hover:text-white">View on GitHub</a>\n              </div>\n\n              <div className="mt-16 flex max-w-2xl items-start gap-4 border-t border-white/10 pt-5 sm:mt-20">\n                <span className="mt-2 h-px w-8 shrink-0 bg-zinc-700" />\n                <p className="text-xs leading-6 text-zinc-600 sm:text-sm">Pages are discovered automatically. Routes still come from each Unit's trigger.</p>\n              </div>\n            </div>\n          </section>\n        </main>\n      </div>\n    </div>\n  );\n}\n`
